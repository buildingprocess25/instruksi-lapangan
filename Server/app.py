...
def check_status():
    """Endpoint untuk diakses frontend saat inisialisasi halaman.
    Mengembalikan informasi submission user (active codes, rejected submissions, dll).
    """
    ...
    try:
        ...
        # Pastikan selalu mengirim JSON (jangan render HTML) sehingga client dapat parse
